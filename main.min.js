const menu=document.querySelector(".menu-section"),menuMobileBtn=document.querySelector(".menu-mobile-btn"),menuMobile=document.querySelector(".menu-mobile"),menuItems=document.querySelectorAll(".menu-mobile-items .menu-item"),menuMobileBtnClose=document.querySelector(".menu-mobile-btn-close"),subMenu=document.querySelector(".sub-menu"),overlay=document.querySelector(".overlay");let prevScrollpos=window.pageYOffset,isMenuSliding=!1;window.onscroll=function(){let e=window.pageYOffset;e>200?menu.classList.add("sticky"):menu.classList.remove("sticky","slide-up"),!isMenuSliding&&e>400&&e>prevScrollpos?(menu.classList.add("slide-up"),isMenuSliding=!0):isMenuSliding&&e<prevScrollpos&&(menu.classList.remove("slide-up"),isMenuSliding=!1),prevScrollpos=e},menuMobileBtn.addEventListener("click",(()=>{menuMobile.style.transform="translateX(320px)",overlay.style.visibility="visible"})),menuMobileBtnClose.addEventListener("click",(()=>{menuMobile.style.transform="translateX(-320px)",overlay.style.visibility="hidden"})),overlay.addEventListener("click",(()=>{menuMobile.style.transform="translateX(-320px)",overlay.style.visibility="hidden"})),menuItems.forEach((e=>{e.addEventListener("click",(()=>{const t=e.querySelector(".sub-menu");"visible"===t.style.visibility?(t.style.visibility="hidden",t.style.opacity="0"):(document.querySelectorAll(".sub-menu").forEach((e=>{e.style.visibility="hidden",t.style.opacity="0"})),t.style.visibility="visible",t.style.opacity="1")}))})),
/*!
